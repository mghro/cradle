...
as_api_type(thinknode_type_info const& tn)
{
    switch (get_tag(tn))
    {
     ...
     case thinknode_type_info_tag::OPTIONAL_TYPE:
        return make_api_type_info_with_optional(as_api_type(as_optional_type(tn)));
     case thinknode_type_info_tag::REFERENCE_TYPE:
        return make_api_type_info_with_reference(as_api_type(as_reference_type(tn)));
